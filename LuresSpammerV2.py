...
class OWL():
    ...
    async def start(self):
        ...
        async def askChoice():
            ...
            if choice.__eq__('1'):
                ...
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
                      "Thank you for using LuresSpammerV2")
                exit()
            else:
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
    ...
    async def screen12(self):
        ...
        print(
            ...
            'Info: Hello User, This is LuresSpammerV2, a new spammer for discord. This tool is for spamming discord\'s api and troll servers/users. We want this to be famous and yeah, hope you like it <3.'
        )
        print(" ")
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
    ...
    def exit(self):
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
                  Fore.CYAN + "Thank you for using LuresSpammerV2")
        exit()
    ...
    def sendText(self, screen='main'):
        ...
        print(
            ...
            .center(self.center))
        print(
            '    |    __ _________   ____   ______/   _____/__________    _____   _____   __________\   \ /   /\_____  \   '
            .center(self.center))
        print(
            '|    |   |  |  \_  __ \_/ __ \ /  ___/\_____  \\____ \__  \  /     \ /     \_/ __ \_  __ \   Y   /  /  ____/  '
            .center(self.center))
        print(
            '|    |___|  |  /|  | \/\  ___/ \___ \ /        \  |_> > __ \|  Y Y  \  Y Y  \  ___/|  | \/\     /  /       \  '
            .center(self.center))
        print(
            '|_______ \____/ |__|    \___  >____  >_______  /   __(____  /__|_|  /__|_|  /\___  >__|    \___/   \_______ \ '
            .center(self.center))
        print(
            '        \/                  \/     \/        \/|__|       \/      \/      \/     \/                        \/ '
            .center(self.center))
        ...
        print((Fore.MAGENTA + '                         Developed by ' +
               ...
               'Lures' + Fore.RESET).center(self.center))
        print(' ')
